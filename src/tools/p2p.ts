...
export function registerP2PTools(server: McpServer): void {
  ...
  server.tool(
    ...
    'Get P2P merchant account info for the authenticated user.',
    {},
    async () => {
      try {
        requireAuth();
  ...
  server.tool(
    ...
    'Get P2P merchant info for a counterparty by their user ID.',
    {
  ...
  server.tool(
    ...
    'Get available payment methods for the authenticated P2P merchant.',
    {
  ...
  server.tool(
    ...
    'List completed P2P transactions.',
    {
      crypto_currency: z.string().describe('Crypto currency e.g. USDT'),
      fiat_currency: z.string().describe('Fiat currency e.g. USD'),
      select_type: z.string().optional().describe('Selection type filter'),
  ...
  server.tool(
    ...
    'Get details of a specific P2P transaction.',
    {
  ...
  server.tool(
    ...
    'Confirm payment for a P2P transaction.',
    {
  ...
  server.tool(
    ...
    'Confirm receipt of payment for a P2P transaction.',
    {
      trade_id: z.string().describe('Trade ID'),
    },
    async ({ trade_id }) => {
  ...
  server.tool(
    'cex_p2p_ads_detail',
    'Get details of a P2P advertisement.',
    {
  ...
  server.tool(
    'cex_p2p_my_ads_list',
    'List my own P2P advertisements.',
    {
  ...
  server.tool(
    'cex_p2p_ads_list',
    'List all available P2P advertisements for a given asset and fiat pair.',
    {
  ...
  server.tool(
    ...
    'Get chat messages for a P2P transaction.',
    {
      txid: z.number().int().describe('Transaction ID'),
