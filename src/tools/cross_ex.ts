  ...
  server.tool(
    ...
    async ({ coin, amount, from, to, text }) => {
      try {
        ...
        const req = new InlineObject10();
        req.coin = coin;
        req.amount = amount;
        req.from = from;
        req.to = to;
        if (text !== undefined) req.text = text;
        const { body } = await new CrossExApi(createClient()).createCrossexTransfer({ inlineObject10: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ symbol, side, type, qty, price, quote_qty, time_in_force, reduce_only, position_side, text }) => {
      try {
        ...
        req.symbol = symbol;
        req.side = side as unknown as typeof InlineObject11.Side[keyof typeof InlineObject11.Side];
        if (type !== undefined) req.type = type as unknown as typeof InlineObject11.Type[keyof typeof InlineObject11.Type];
        if (qty !== undefined) req.qty = qty;
        if (price !== undefined) req.price = price;
        if (quote_qty !== undefined) req.quoteQty = quote_qty;
        if (time_in_force !== undefined) req.timeInForce = time_in_force as unknown as typeof InlineObject11.TimeInForce[keyof typeof InlineObject11.TimeInForce];
        if (reduce_only !== undefined) req.reduceOnly = (reduce_only ? 'true' : 'false') as unknown as typeof InlineObject11.ReduceOnly[keyof typeof InlineObject11.ReduceOnly];
        if (position_side !== undefined) req.positionSide = position_side as unknown as typeof InlineObject11.PositionSide[keyof typeof InlineObject11.PositionSide];
        if (text !== undefined) req.text = text;
        const { body } = await new CrossExApi(createClient()).createCrossexOrder({ inlineObject11: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ order_id, qty, price }) => {
      try {
        ...
        if (qty !== undefined) req.qty = qty;
        if (price !== undefined) req.price = price;
        const { body } = await new CrossExApi(createClient()).updateCrossexOrder(order_id, { inlineObject12: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ exchange_type, from_coin, to_coin, from_amount }) => {
      try {
        ...
        const { body } = await new CrossExApi(createClient()).createCrossexConvertQuote({ inlineObject13: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ quote_id }) => {
      try {
        ...
        const { body } = await new CrossExApi(createClient()).createCrossexConvertOrder({ inlineObject14: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ position_mode, account_mode, exchange_type }) => {
      try {
        ...
        const { body } = await new CrossExApi(createClient()).updateCrossexAccount({ inlineObject15: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ symbol, leverage }) => {
      try {
        ...
        const { body } = await new CrossExApi(createClient()).updateCrossexPositionsLeverage({ inlineObject16: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ symbol, leverage }) => {
      try {
        ...
        req.symbol = symbol;
        req.leverage = leverage;
        const { body } = await new CrossExApi(createClient()).updateCrossexMarginPositionsLeverage({ inlineObject17: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
  ...
  server.tool(
    ...
    async ({ symbol, position_side }) => {
      try {
        ...
        const { body } = await new CrossExApi(createClient()).closeCrossexPosition({ inlineObject18: req });
        return textContent(body);
      } catch (e) { return errorContent(e); }
    }
  );
