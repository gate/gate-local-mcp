...
console.log('\n── Unknown module handling ──────────────────────────────────────────────');
{
  ...
  expect('valid modules still load despite unknown name', t.count, 32);
}
